...
// MessageRole/ChatMessage/ToolCall/LlmResponse/LlmStreamChunk/ILlmClient 在 Session/ProtocolTypes.cs（同命名空间）

/// <summary>OpenAI 兼容的 LLM 客户端（支持 deepseek 等）。
/// 原 WTangent.Server/Session/LlmClient.cs，LLM 设施公共化并入 Core。</summary>
